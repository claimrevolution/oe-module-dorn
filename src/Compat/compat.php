...
/**
 * Compatibility shims for running the DORN module on OpenEMR 7.x.
 *
...
if (!class_exists(\OpenEMR\Core\OEGlobalsBag::class, false)) {
    ...
    if (!class_exists(\OpenEMR\Core\OEGlobalsBag::class)) {
        ...
        class_alias(\OpenEMR\Modules\Dorn\Compat\OEGlobalsBagShim::class, \OpenEMR\Core\OEGlobalsBag::class);
    }
}
...
if (!interface_exists(\OpenEMR\Common\Crypto\CryptoInterface::class, false)) {
    if (!interface_exists(\OpenEMR\Common\Crypto\CryptoInterface::class)) {
        ...
        class_alias(\OpenEMR\Modules\Dorn\Compat\CryptoInterfaceShim::class, \OpenEMR\Common\Crypto\CryptoInterface::class);
    }
}
...
if (!class_exists(\OpenEMR\BC\ServiceContainer::class, false)) {
    if (!class_exists(\OpenEMR\BC\ServiceContainer::class)) {
        ...
        class_alias(\OpenEMR\Modules\Dorn\Compat\ServiceContainerShim::class, \OpenEMR\BC\ServiceContainer::class);
    }
}
